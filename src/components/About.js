...
const About = () => {
    return (
        <section className=' bg-gradient-to-b from-black bg-slate-600 flex py-20 sm:px-4  justify-center font-serif'>
            <div id="about" className='rounded-3xl bg-about bg-no-repeat bg-cover bg-center container mx-16 fl ex flex-col bg-slate-200 justify-center w-[85%] h-1/2'>
                <div className='justify-center pb-1.5 flex'>
                    <div className=' font-sans rounded-b-xl text-gray-300 font-semibold bg-black text-2xl pb-2 px-8'>About Me</div>
                </div>
                    ...
                    <div className='pr-6 pl-10 flex pb-10 text-black'>
                        <div className="flex-1 flex-col pr-6 ">
                            <div className='pb-6 flex flex-col flex-1'>
                                <div className='pb-1'>
                                    <text className='shadow-lg shadow-gray-600 font-semibold bg-black text-gray-300 p-1'>Introduction</text>
                                </div>
                                ...
                                <div className='pb-6 drop-shadow-2xl flex flex-col shrink'>
                                    <div className='pb-2 pt-2'>
                                        <text className='shadow-lg shadow-gray-600 font-semibold bg-black text-gray-300 p-1'>Education & Certification</text>
                                    </div>
